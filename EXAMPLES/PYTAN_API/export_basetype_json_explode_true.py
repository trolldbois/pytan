...
...CALLING: handler.export_obj() with args {'export_format': u'json', 'explode_json_string_values': True, 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x10ad6dc50>}
