...
...CALLING: handler.export_obj() with args {'export_format': u'xml', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x110cbd110>, 'minimal': u'bad'}
