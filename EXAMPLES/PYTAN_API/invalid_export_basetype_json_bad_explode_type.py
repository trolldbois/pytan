...
kwargs["explode_json_string_values"] = u'bad'
...
...CALLING: handler.export_obj() with args {'export_format': u'json', 'explode_json_string_values': u'bad', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x11eedf0d0>}
