...
{'poller_object': None,
 'poller_success': None,
 'question_object': <taniumpy.object_types.question.Question object at 0x106bbcfd0>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x11ade9090>,
 'saved_question_object': <taniumpy.object_types.saved_question.SavedQuestion object at 0x10c612050>}
...OUTPUT: Equivalent Question if it were to be asked in the Tanium Console: 
Get Installed Applications from all machines
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x11ade9090>}
