...
print "...CALLING: handler.create_sensor() with args: {}".format(kwargs)
try:
...
...CALLING: handler.create_sensor() with args: {'unsupported': True}
...EXCEPTION: Sensor creation not supported via PyTan as of yet, too complex
