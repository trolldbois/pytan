...
2015-09-04 03:07:24,083 INFO     pytan.pollers.QuestionPoller: ID 10238: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x109f6ee90>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x109f61f50>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x109f61310>,
 'saved_question_object': <taniumpy.object_types.saved_question.SavedQuestion object at 0x109f6e750>}
...OUTPUT: Equivalent Question if it were to be asked in the Tanium Console: 
Get number of machines
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x109f61310>}
