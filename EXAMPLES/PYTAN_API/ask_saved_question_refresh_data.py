...
2015-09-05 05:48:44,784 INFO     pytan.pollers.QuestionPoller: ID 11660: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x1125450d0>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x10d8fdf90>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x10d8fd050>,
 'saved_question_object': <taniumpy.object_types.saved_question.SavedQuestion object at 0x112898b90>}
...OUTPUT: Equivalent Question if it were to be asked in the Tanium Console: 
Get number of machines
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x10d8fd050>}
