...
...CALLING: handler.export_obj() with args {'export_format': u'csv', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x10af3bf10>, 'header_sort': [u'name', u'description']}
