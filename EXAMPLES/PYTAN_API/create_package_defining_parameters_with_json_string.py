...
# setup package parameter json string
...
json_formatted_parameter_string = u''.join( json_formatted_parameter_list )
...
...CALLING: handler.create_package() with args: {'expire_seconds': 1500, 'display_name': u'package49 API test', 'name': u'package49', 'verify_expire_seconds': 3600, 'verify_filters': [u'Custom Tags, that contains:tag'], 'command': u'package49 $1 $2', 'file_urls': [u'3600::testing.vbs||https://content.tanium.com/files/initialcontent/bundles/2014-10-01_11-32-15-7844/custom_tagging_-_remove_tags_[non-windows]/CustomTagRemove.sh'], 'parameters_json': u'{"parameters": [{"parameterType": "com.tanium.components.parameters::TextInputParameter","model": "com.tanium.components.parameters::TextInputParameter","key": "$1","validationExpressions": [{"expression": "","helpString": "","model": "com.tanium.models::ValidationExpression","parameterType": "com.tanium.models::ValidationExpression"}],"label": "TextInput","helpString": "This is a parameter added with a JSON string."},{"parameterType": "com.tanium.components.parameters::CheckBoxParameter","model": "com.tanium.components.parameters::CheckBoxParameter","key": "$2","label": "Checkbox","helpString": "This is a parameter added with a JSON string.","defaultValue": 0}],"model": "com.tanium.components.parameters::ParametersArray","parameterType": "com.tanium.components.parameters::ParametersArray"}', 'verify_filter_options': [u'and'], 'command_timeout_seconds': 9999}
...OUTPUT: Type of response:  <class 'taniumpy.object_types.package_spec.PackageSpec'>
...OUTPUT: print of response:
PackageSpec, name: 'package49', id: 72
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.package_spec.PackageSpec object at 0x107647c90>}
...OUTPUT: print the objects returned in JSON format:
{
  "_type": "package_spec",
  "available_time": "2001-01-01T00:00:00",
  "command": "package49 $1 $2",
  "command_timeout": 9999,
  "creation_time": "2017-08-24T04:13:14",
  "deleted_flag": 0,
...
[<taniumpy.object_types.package_spec.PackageSpec object at 0x107645ed0>]
