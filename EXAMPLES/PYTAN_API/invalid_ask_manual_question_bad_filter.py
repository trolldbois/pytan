...
...CALLING: handler.ask() with args: {'sensors': u'Computer name, that does not meet:little', 'qtype': u'manual'}
...EXCEPTION: Filter u' does not meet:little' is not a valid filter!
