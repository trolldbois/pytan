...
create_kwargs = {}
create_kwargs['objtype'] = u'userrole'
...
...CALLING: handler.get() with args: {'objtype': u'userrole', 'name': u'Administrator'}
...CALLING: handler.export_to_report_file() with args: {'report_dir': '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T', 'export_format': 'json', 'obj': <taniumpy.object_types.user_role_list.UserRoleList object at 0x11b485d10>}
...CALLING: handler.create_from_json() with args {'objtype': u'userrole', 'json_file': '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/UserRoleList_2015_09_14-16_15_19-EDT.json'}
...EXCEPTION: userrole is not a json createable object! Supported objects: user, whitelisted_url, saved_question, group, package, question, action, sensor
