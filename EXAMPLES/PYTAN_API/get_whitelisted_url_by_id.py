...
kwargs = {}
kwargs["objtype"] = u'whitelisted_url'
kwargs["id"] = 1
...
...CALLING: handler.get with args: {'objtype': u'whitelisted_url', 'id': 1}
...OUTPUT: Type of response:  <class 'taniumpy.object_types.white_listed_url_list.WhiteListedUrlList'>
...OUTPUT: print of response:
WhiteListedUrlList, len: 1
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.white_listed_url_list.WhiteListedUrlList object at 0x108f45990>}
