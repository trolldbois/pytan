...
2015-09-05 05:46:17,636 INFO     pytan.pollers.QuestionPoller: ID 11650: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x10d057b10>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x10ac90850>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x106eafd50>}
...
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x106eafd50>}
...OUTPUT: CSV Results of response: 
Count,"Folder Name Search with RegEx Match[, , No, No]"
29519,[too many results]
...
1,C:\Program Files (x86)\Tanium\Tanium Client\Downloads\Action_580\grep\share\locale\lt\LC_MESSAGES
...
1,C:\Program Files (x86)\Tanium\Tanium Client\Downloads\Action_590\grep\share\locale\el\LC_MESSAGES
1,C:\Program Files (x86)\Tanium\Tanium Client\Downloads\Action_551\grep\share\locale\el\LC_MESSAGES
1,C:\Program Files (x86)\Tanium\Tanium Client\Downloads\Action_575\grep\contrib\grep\2.5.4\grep-2.5.4
