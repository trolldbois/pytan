...
UserList, len: 1
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.user_list.UserList object at 0x105832190>}
  ...
  "user": [
    {
      ...
      "group_id": 0, 
      "id": 1, 
      "last_login": "2015-09-04T02:56:09", 
      "local_admin_flag": 1, 
      "name": "Administrator", 
      "permissions": {
        "_type": "permissions", 
