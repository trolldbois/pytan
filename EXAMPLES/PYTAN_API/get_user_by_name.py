...
UserList, len: 1
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.user_list.UserList object at 0x1106af1d0>}
  ...
  "user": [
    {
      ...
      "group_id": 0, 
      "id": 1, 
      "last_login": "2015-09-05T05:40:21", 
      "local_admin_flag": 1, 
      "name": "Administrator", 
      "permissions": {
        "_type": "permissions", 
