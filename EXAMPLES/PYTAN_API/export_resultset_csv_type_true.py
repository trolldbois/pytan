...
2015-09-05 05:38:30,540 INFO     pytan.pollers.QuestionPoller: ID 11633: Reached Threshold of 99% (2 of 2)
...CALLING: handler.export_obj() with args {'export_format': u'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x1117eb550>, 'header_add_type': True}
...OUTPUT: print the export_str returned from export_obj():
Computer Name (String),Destination (IPAddress),Flags (String),"Folder Name Search with RegEx Match[Program Files, , No, No, .*Shared.*] (String)",Gateway (IPAddress),IP Address (IPAddress),Interface (String),Mask (String),Metric (NumericInteger)
