...
2015-09-04 03:01:36,766 INFO     pytan.pollers.QuestionPoller: ID 10225: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x1069d05d0>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x1069d0ad0>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x1069d0650>}
...OUTPUT: Equivalent Question if it were to be asked in the Tanium Console: 
Get Computer Name[Dweedle] from all machines
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x1069d0650>}
