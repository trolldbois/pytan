...
...CALLING: handler.export_obj() with args {'export_format': u'json', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x1102935d0>, 'include_type': True}
