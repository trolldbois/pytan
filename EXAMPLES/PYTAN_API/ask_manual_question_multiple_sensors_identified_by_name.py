...
...CALLING: handler.ask with args: {'sensors': [u'name:Computer Name', u'name:Installed Applications'], 'qtype': u'manual'}
2015-09-04 02:58:00,727 INFO     pytan.pollers.QuestionPoller: ID 10221: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x10cc8a950>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x10cc8a390>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x10cc91390>}
...
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x10cc91390>}
