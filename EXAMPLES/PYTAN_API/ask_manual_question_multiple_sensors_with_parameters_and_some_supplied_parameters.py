...
...CALLING: handler.ask with args: {'sensors': [u'Folder Name Search with RegEx Match{dirname=Program Files,regex=Microsoft.*}', u'Computer Name'], 'qtype': u'manual'}
2015-09-05 05:45:22,109 INFO     pytan.pollers.QuestionPoller: ID 11647: Reached Threshold of 99% (2 of 2)
...OUTPUT: Type of response:  <type 'dict'>
...OUTPUT: Pretty print of response:
{'poller_object': <pytan.pollers.QuestionPoller object at 0x12f02d990>,
 'poller_success': True,
 'question_object': <taniumpy.object_types.question.Question object at 0x1179a0490>,
 'question_results': <taniumpy.object_types.result_set.ResultSet object at 0x10ec31c10>}
...
...CALLING: handler.export_obj() with args {'export_format': 'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x10ec31c10>}
...
TPT1-0.localdomain,"C:\Program Files\OpenSSH\home\Administrator\Documents\SQL Server Management Studio\Templates\ItemTemplates
C:\Program Files\VMware\VMware Tools\plugins\vmsvc
C:\Program Files\OpenSSH\home\All Users\Microsoft\Windows\Start Menu\Programs\7-Zip
...
C:\Program Files\OpenSSH\home\All Users\Microsoft\Windows\Start Menu\Programs\Microsoft SQL Server 2012\Integration Services
C:\Program Files\Tanium\Tanium Server\http\tux\spin\src
C:\Program Files\OpenSSH\home\Administrator\AppData\Roaming\Macromedia\Flash Player\macromedia.com\support\flashplayer
