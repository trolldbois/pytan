...
kwargs["header_sort"] = [u'Computer Name', u'IP Address']
...
2015-09-05 05:36:49,955 INFO     pytan.pollers.QuestionPoller: ID 11630: Reached Threshold of 99% (2 of 2)
...CALLING: handler.export_obj() with args {'export_format': u'csv', 'obj': <taniumpy.object_types.result_set.ResultSet object at 0x1127121d0>, 'header_sort': [u'Computer Name', u'IP Address']}
...OUTPUT: print the export_str returned from export_obj():
Computer Name,IP Address,Destination,Flags,"Folder Name Search with RegEx Match[Program Files, , No, No, .*Shared.*]",Gateway,Interface,Mask,Metric
Casus-Belli.local,"2604:2000:1200:60de:dd68:f4b6:d5ee:e562
172.16.31.1
