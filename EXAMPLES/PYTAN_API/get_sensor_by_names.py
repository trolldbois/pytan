...
kwargs["name"] = [u'Computer Name', u'Action Statuses']
...
SensorList, len: 2
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x110647d90>}
