...
2015-08-06 14:56:09,905 INFO     pytan.handler: New package 'package49' created with ID 9343, command: 'package49 $1 $2 $3 $4 $5 $6 $7 $8'

Type of response:  <class 'taniumpy.object_types.package_spec.PackageSpec'>

print of response:
PackageSpec, name: 'package49', id: 9343
...
print the object returned in JSON format:
{
  ...
  "source_id": 0, 
  "verify_group_id": 27379
}
2015-08-06 14:56:09,920 INFO     pytan.handler: Deleted 'PackageSpec, id: 9343'
