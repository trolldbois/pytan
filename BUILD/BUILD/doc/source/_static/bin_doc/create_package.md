...
New package '1234 CMDLINE TEST package' created with ID 83, command: 'testing.vbs $1 $2 $3 $4 $5 $6 $7 $8'
```
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Deleted item:  PackageSpec, id: 83
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:33:57 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**