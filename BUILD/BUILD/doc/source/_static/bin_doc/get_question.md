...
Found items:  QuestionList, len: 530
Report file '/tmp/out.json' written with 411563 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  QuestionList, len: 530
Report file '/tmp/out.csv' written with 83882 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  QuestionList, len: 530
Report file '/tmp/out.xml' written with 83882 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:35:46 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**