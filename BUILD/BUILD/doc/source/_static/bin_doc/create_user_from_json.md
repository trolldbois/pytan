  ...
  "user": [
    {
      ...
      "group_id": 0, 
      "id": 1, 
      "last_login": "2015-09-14T19:33:54", 
      "local_admin_flag": 1, 
...trimmed for brevity...
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 3279"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "user": [
    {
      ...
      "last_login": "2015-09-14T19:33:54", 
      "local_admin_flag": 1, 
      "name": "Administrator CMDLINE TEST 3279", 
      "permissions": {
        "_type": "permissions", 
        "permission": [
          "admin", 
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: User, name: 'Administrator CMDLINE TEST 3279', id: 27, ID: 27
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:34:19 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**