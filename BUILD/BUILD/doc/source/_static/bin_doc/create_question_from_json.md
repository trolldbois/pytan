...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 2451"/gm' /tmp/out.json && cat /tmp/out.json
```
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: Question, id: 678, ID: 678
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:34:02 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**