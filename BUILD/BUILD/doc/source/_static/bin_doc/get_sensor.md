...
Found items:  SensorList, len: 428
Report file '/tmp/out.json' written with 2827536 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SensorList, len: 428
Report file '/tmp/out.csv' written with 2192330 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SensorList, len: 428
Report file '/tmp/out.xml' written with 2192330 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:37:12 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**