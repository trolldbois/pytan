...
Found items:  ActionList, len: 60
Report file '/tmp/out.json' written with 86676 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  ActionList, len: 60
Report file '/tmp/out.csv' written with 21638 bytes
```
...
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  ActionList, len: 60
Report file '/tmp/out.xml' written with 21638 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:35:30 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**