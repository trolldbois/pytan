...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 3204"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "white_listed_url": [
    {
      ...
      "url_regex": "regex:https://testing.com/4077 CMDLINE TEST 3204"
    }
  ]
}
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:34:23 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**