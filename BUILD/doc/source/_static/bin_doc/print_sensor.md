...
```bash
print_sensor.py -u 'Tanium User' -p 'T@n!um' --host '172.16.31.128' --loglevel 1 --all
```

```
Handler for Session to 172.16.31.128:443, Authenticated: True, Version: Not yet determined!
Found items:  SensorList, len: 404
  ...
  * Sensor Name: 'Action Statuses CMDLINE TEST 5339', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 7057', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 2288', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed
...
```bash
print_sensor.py -u 'Tanium User' -p 'T@n!um' --host '172.16.31.128' --loglevel 1 --all --platform Linux
```
...
```bash
print_sensor.py -u 'Tanium User' -p 'T@n!um' --host '172.16.31.128' --loglevel 1 --all --platform Linux --category "Operating System"
```
...
```bash
print_sensor.py -u 'Tanium User' -p 'T@n!um' --host '172.16.31.128' --loglevel 1 --all --platform Mac --platform Windows --category "User"
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Fri Aug  7 15:34:33 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**