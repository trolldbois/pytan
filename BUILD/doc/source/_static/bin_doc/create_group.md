...
New group 'All Windows Computers CMDLINE TEST GROUP' created with ID 2446, filter text: ' Operating System contains "Windows" and IP Address = "10.10.10.10"'
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Wed Feb 11 17:12:36 2015 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**