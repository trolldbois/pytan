...
Found items:  PackageSpecList, len: 59
Report file '/tmp/out.json' written with 179177 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  PackageSpecList, len: 59
Report file '/tmp/out.csv' written with 87003 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  PackageSpecList, len: 59
Report file '/tmp/out.xml' written with 87003 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Fri Oct  2 16:08:01 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**