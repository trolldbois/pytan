...
<a name='toc'>Table of contents:</a>
  ...
  * [Help for Get Userrole](#user-content-help-for-get-userrole)
  * [Export all userrole objects as JSON](#user-content-export-all-userrole-objects-as-json)
  * [Export all userrole objects as CSV](#user-content-export-all-userrole-objects-as-csv)
  * [Export all userrole objects as xml](#user-content-export-all-userrole-objects-as-xml)

---------------------------

# Help for Get Userrole

  * Print the help for get_userrole.py
  * All scripts in bin/ will supply help if -h is on the command line
  * If passing in a parameter with a space or a special character, you need to surround it with quotes properly. On Windows this means double quotes. On Linux/Mac, this means single or double quotes, depending on what kind of character escaping you need.
  * If running this script on Linux or Mac, use the python scripts directly as the bin/get_userrole.py
  * If running this script on Windows, use the batch script in the winbin/get_userrole.bat so that python is called correctly.
...
```
usage: get_userrole.py [-h] [-u USERNAME] [-p PASSWORD]
...
# Export all userrole objects as JSON

  * Get all userrole objects
  * Save the results to a JSON file

```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --port 443 --loglevel 1 --all --file "/tmp/out.json" --export_format json
```
...
Report file '/tmp/out.json' written with 4619 bytes
```
...
# Export all userrole objects as CSV

  * Get all userrole objects
  * Save the results to a csv file

```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --port 443 --loglevel 1 --all --file "/tmp/out.csv"
```

```
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  UserRoleList, len: 9
Report file '/tmp/out.csv' written with 2540 bytes
```
...
# Export all userrole objects as xml

  * Get all userrole objects
  * Save the results to a xml file

```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --port 443 --loglevel 1 --all --file "/tmp/out.xml"
```

```
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  UserRoleList, len: 9
Report file '/tmp/out.xml' written with 2540 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Tue Sep 15 18:25:46 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**