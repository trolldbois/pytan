...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 8779"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "package_spec": [
    {
      ...
      "name": "Update Java 64-bit - Kill / Reboot CMDLINE TEST 8779", 
      "skip_lock_flag": 0, 
      "source_id": 0, 
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: PackageSpec, name: 'Update Java 64-bit - Kill / Reboot CMDLINE TEST 8779', id: 87, ID: 87
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:50:47 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**