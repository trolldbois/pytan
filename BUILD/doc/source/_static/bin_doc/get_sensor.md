...
Report file '/tmp/out.json' written with 4135426 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SensorList, len: 567
Report file '/tmp/out.csv' written with 3349958 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SensorList, len: 567
Report file '/tmp/out.xml' written with 3349958 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Fri Oct  2 16:09:25 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**