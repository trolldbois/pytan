...
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json' written with 4596 bytes
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 3855"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "saved_question": [
    {
      ...
      "keep_seconds": 3600, 
      "mod_time": "2015-03-03T19:04:39", 
      "mod_user": {
        "_type": "user", 
        "name": "Jim Olsen"
      }, 
      "most_recent_question_id": 32455, 
      "name": "Run Unmanaged Asset Scan on All Machines CMDLINE TEST 3855", 
      "packages": {
        "_type": "package_specs", 
        "package_spec": []
      }, 
      ...
      "question": {
        "_type": "question", 
        "action_tracking_flag": 0, 
        "expiration": "2015-03-26T13:15:59", 
        "expire_seconds": 0, 
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3279
Created item: SavedQuestion, name: 'Run Unmanaged Asset Scan on All Machines CMDLINE TEST 3855', ID: 11656
```
