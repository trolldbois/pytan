...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 8057"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "saved_question": [
    {
      ...
      "most_recent_question_id": 104, 
      "name": "Has Tanium Standard Utilities CMDLINE TEST 8057", 
      "packages": {
        "_type": "package_specs", 
        "package_spec": [
          {
      ...
      "question": {
        "_type": "question", 
        "action_tracking_flag": 0, 
        "expiration": "2015-08-07T13:32:29", 
        "expire_seconds": 0, 
...
```
Handler for Session to 172.16.31.128:443, Authenticated: True, Version: Not yet determined!
Created item: SavedQuestion, name: 'Has Tanium Standard Utilities CMDLINE TEST 8057', id: 107, ID: 107
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Fri Aug  7 10:27:50 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**