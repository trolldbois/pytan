...
Report file '/tmp/out.json' written with 11882 bytes
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 7902"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "saved_question": [
    {
      ...
      "most_recent_question_id": 689, 
      "name": "Has Tanium Standard Utilities CMDLINE TEST 7902", 
      "packages": {
        "_type": "package_specs", 
        "package_spec": [
          {
      ...
      "question": {
        "_type": "question", 
        "action_tracking_flag": 0, 
        "expiration": "2015-09-14T19:49:33", 
        "expire_seconds": 0, 
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: SavedQuestion, name: 'Has Tanium Standard Utilities CMDLINE TEST 7902', id: 112, ID: 112
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:50:53 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**