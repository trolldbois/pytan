...
Report file '/tmp/out.json' written with 6893 bytes
```
...
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SavedActionList, len: 4
Report file '/tmp/out.csv' written with 2243 bytes
```
...
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SavedActionList, len: 4
Report file '/tmp/out.xml' written with 2243 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Tue Sep 15 18:25:03 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**