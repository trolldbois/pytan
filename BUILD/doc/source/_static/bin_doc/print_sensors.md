...
```bash
bin/print_sensors.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all
```

```
PyTan v2.1.0 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SensorList, len: 1696
Filtered out sourced sensors: 330
Filtered out sensors based on user filters: 330
  ...
  * Sensor Name: 'Installed Applications', Platforms: Windows, Linux, Mac, Category: Applications
  ...
  * Sensor Name: 'Running Processes', Platforms: Windows, Linux, Mac, Category: Applications
  ...
  * Sensor Name: 'Running Service', Platforms: Windows, Linux, Mac, Category: Applications
  ...
  * Sensor Name: 'Running Processes Memory Usage', Platforms: Windows, Category: Applications
  ...
  * Sensor Name: 'Folder Name Search with RegEx Match', Platforms: Windows, Category: File System
  * Description: Finds the specified folder and provides the full path if the folder exists on the client machine. Takes regular expression to match. Example: C:\WINDOWS\System32
  * Parameter 'dirname':
    - 'helpString': Enter the folder name to search for
    - 'label': Search for Folder Name
    - 'promptText': e.g Program Files
  * Parameter 'regexp':
    - 'helpString': Enter the regular expression to search for.
    - 'label': Regular Expression
    - 'promptText': e.g. test*.exe
  * Parameter 'casesensitive':
    - 'helpString': Enter Yes/No for case sensitivity of search.
    - 'label': Case sensitive?
    - 'requireSelection': True
    - 'values': [u'No', u'Yes']
  * Parameter 'global':
    - 'helpString': Enter Yes/No whether the search is global.
    - 'label': Global
    - 'requireSelection': True
    - 'values': [u'No', u'Yes']

  * Sensor Name: 'File Name Search', Platforms: Windows, Category: File System
  * Description: Finds the specified file and provides the full path if the file exists on the client machine. Example: C:\WINDOWS\System32\Notepad.exe
  * Parameter 'filename':
    - 'helpString': Enter the file name only to search for.
    - 'label': File name to search for
    - 'promptText': e.g. test.txt

  * Sensor Name: 'Folder Name Search', Platforms: Windows, Category: File System
  * Description: Finds the specified folder and provides the full path if the folder exists on the client machine. Example: C:\WINDOWS\System32
  * Parameter 'dirname':
    - 'helpString': Enter the folder name only to search for.
    - 'label': Folder name to search for
    - 'promptText': e.g. Program Files
  ...
  * Sensor Name: 'File Name Search with RegEx Match', Platforms: Windows, Category: File System
  * Description: Finds the specified file and provides the full path if the file exists on the client machine. Takes regular expression to match. Example: C:\WINDOWS\System32\Notepad.exe
  * Parameter 'filename':
    - 'helpString': Enter the file name only to search for
    - 'label': File Name
    - 'promptText': e.g test.txt
  ...
  * Sensor Name: 'File Size', Platforms: Windows, Mac, Category: File System
  ...
  * Sensor Name: 'Is Virtual', Platforms: Windows, Mac, Category: Hardware
  * Description: Returns Yes or No to indicate whether the hardware is virtual. Echo: Yes

  * Sensor Name: 'Chassis Type', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'CPU Details', Platforms: Windows, Mac, Category: Hardware
  ...
  * Sensor Name: 'Disk Drives', Platforms: Windows, Mac, Category: Hardware
  * Description: Descriptions of any installed disk drives, including external or USB drives. Example: ST3808110AS ATA Device

  * Sensor Name: 'Disk Total Space', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: The amount of total disk space per drive. Example: C: 100 GB

  * Sensor Name: 'Disk Free Space', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: The amount of free disk space per drive. Example: C: 40 GB

  * Sensor Name: 'Disk Used Percentage', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: The percentage of used disk space per partition. Example: C: 24%

  * Sensor Name: 'RAM', Platforms: Windows, Mac, Category: Hardware
  ...
  * Sensor Name: 'BIOS Release Date', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: Release date of the BIOS. Example: 20080436.2.314..001100+000

  * Sensor Name: 'BIOS Version', Platforms: Windows, Linux, Category: Hardware
  * Description: Version of the BIOS. Example: A11

  * Sensor Name: 'CPU Speed Mhz', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'Computer Serial Number', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: The serial number, if available, provided by the computer manufacturer. Example: 123ABC1

  * Sensor Name: 'Virtual Platform', Platforms: Windows, Category: Hardware
  ...
  * Sensor Name: 'Free Memory', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'BIOS Vendor', Platforms: Windows, Linux, Category: Hardware
  ...
  * Sensor Name: 'CPU Manufacturer', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'CPU Architecture', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'Network Adapter Name', Platforms: Windows, Linux, Category: Hardware
  * Description: Returns the names of network adapters that are active. Example: VMware Accelerated AMD PCNet Adapter

  * Sensor Name: 'CPU', Platforms: Windows, Linux, Mac, Category: Hardware
  * Description: Description of the CPU. Example: Intel(R) Core(TM) i5-2500 CPU @ 3.30GHz

  * Sensor Name: 'Model', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'Total Memory', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'Number of Processors', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'CPU Family', Platforms: Windows, Linux, Category: Hardware
  ...
  * Sensor Name: 'Disk Used Space', Platforms: Windows, Linux, Mac, Category: Hardware
  ...
  * Sensor Name: 'Online', Platforms: Windows, Linux, Mac, Category: Miscellaneous
  ...
  * Sensor Name: 'Client Date', Platforms: Windows, Linux, Mac, Category: Miscellaneous
  ...
  * Sensor Name: 'MAC Address', Platforms: Windows, Linux, Mac, Category: Network
  ...
  * Sensor Name: 'Network Link Speed', Platforms: Windows, Category: Network
  ...
  * Sensor Name: 'Network Throughput Outbound', Platforms: Windows, Category: Network
  ...
  * Sensor Name: 'Network Throughput Inbound', Platforms: Windows, Category: Network
  ...
  * Sensor Name: 'Subnet Mask', Platforms: Windows, Category: Network
  ...
  * Sensor Name: 'Listen Ports', Platforms: Windows, Linux, Mac, Category: Network
  ...
  * Sensor Name: 'Hosts File Entries', Platforms: Windows, Linux, Mac, Category: Network
  ...
  * Sensor Name: 'IP Route Details', Platforms: Windows, Linux, Mac, Category: Network
  ...
  * Sensor Name: 'IP Routes', Platforms: Windows, Linux, Mac, Category: Network
  * Description: Returns IPv4 network routes, filtered to exclude noise. Example:  172.16.0.0|192.168.1.1|255.255.0.0

  * Sensor Name: 'Open Port', Platforms: Windows, Linux, Mac, Category: Network
  ...
  * Sensor Name: 'Operating System', Platforms: Windows, Linux, Mac, Category: Operating System
  ...
  * Sensor Name: 'Is Windows', Platforms: Windows, Linux, Mac, Category: Operating System
  * Description: Returns whether the machine runs Windows.  True if so, False if not. Example: True

  * Sensor Name: 'Local Groups With Members', Platforms: Windows, Category: Operating System
  * Description: Returns a group name and a member of that group on each line. For each member in any group, two columns of output will appear. Example: Administrators|user.name

  * Sensor Name: 'Local Groups', Platforms: Windows, Linux, Category: Operating System
  * Description: Returns the names of Local Groups on Windows machines. Example:Administrators

  * Sensor Name: 'Uptime', Platforms: Windows, Linux, Mac, Category: Operating System
  ...
  * Sensor Name: 'Memory Consumption', Platforms: Windows, Mac, Category: Operating System
  * Description: Returns the percentage of used (committed) memory on a system. Example: 27 percent

  * Sensor Name: 'Service Pack', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Operating System Install Date', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Username', Platforms: Windows, Linux, Mac, Category: Operating System
  ...
  * Sensor Name: 'Boot Device', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Operating System Boot Directory', Platforms: Windows, Category: Operating System
  * Description: Returns the directory the Operating System boots from. Example:\\Windows

  * Sensor Name: 'Mapped Drives', Platforms: Windows, Category: Operating System
  * Description: Returns share names of network shares which are mapped locally. Example: \\\\server\\share
  ...
  * Sensor Name: 'Time Zone', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Operating System Temp Directory', Platforms: Windows, Category: Operating System
  * Description: Returns the gobal temp directory of the Operating System. Example: C:\Temp

  * Sensor Name: 'Load Average', Platforms: Linux, Mac, Category: Operating System
  * Description: Returns the average CPU load on a Mac or Linux system  Example: 0.00 0.03 0.10

  * Sensor Name: 'Installed HotFixes', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Maximum Process Memory Size', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Is Mac', Platforms: Windows, Linux, Mac, Category: Operating System
  * Description: Returns whether the machine is a Mac.  True if so, False if not. Example: True

  * Sensor Name: 'Last Reboot', Platforms: Windows, Linux, Mac, Category: Operating System
  * Description: Returns the time the last reboot occurred. Example: 2012-12-11 09:01

  * Sensor Name: 'Time Zone Offset', Platforms: Windows, Linux, Mac, Category: Operating System
  * Description: Returns the time offset in minutes. Example: -0700

  * Sensor Name: 'Low Disk Space', Platforms: Windows, Category: Operating System
  * Description: Returns disk drives which have less than 2 gigabytes free. Example: C:

  * Sensor Name: 'Number Of Users', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Total Swap', Platforms: Linux, Category: Operating System
  ...
  * Sensor Name: 'Is Linux', Platforms: Windows, Linux, Mac, Category: Operating System
  ...
  * Sensor Name: 'Used Swap', Platforms: Linux, Category: Operating System
  ...
  * Sensor Name: 'Free Swap', Platforms: Linux, Category: Operating System
  ...
  * Sensor Name: 'Run Level', Platforms: Linux, Category: Operating System
  ...
  * Sensor Name: 'CPU by Process', Platforms: Windows, Category: Operating System
  ...
  * Sensor Name: 'Kernel Modules', Platforms: Linux, Category: Operating System
  ...
  * Sensor Name: 'Is Mac API TEST', Platforms: Windows, Linux, Mac, Category: Operating System
  * Description: Returns whether the machine is a Mac.  True if so, False if not. Example: True
  ...
  * Sensor Name: 'Action Statuses CMDLINE TEST 1631', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 1821', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 7367', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 6543', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 5327', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 1758', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 6571', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 5', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 157', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 4024', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 4964', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed

  * Sensor Name: 'Action Statuses CMDLINE TEST 6716', Platforms: Windows, Category: Reserved
  * Description: The recorded state of each action a client has taken recently in the form of id:status. Example: 1:Completed
  ...
  * Sensor Name: 'High Uptime', Platforms: Windows, Linux, Mac, Category: Software
  * Description: Indicates whether the client machine has been online for more than 30 days. Example: Less than 30 days

  * Sensor Name: 'Local User Login Dates', Platforms: Windows, Category: Software
  ...
  * Sensor Name: 'Tanium Client Version', Platforms: Windows, Linux, Mac, Category: Tanium
  ...
  * Sensor Name: 'Tanium Client Installation Date', Platforms: Windows, Mac, Category: Tanium
  ...
  * Sensor Name: 'Tanium Client Installation Time', Platforms: Windows, Mac, Category: Tanium
  ...
  * Sensor Name: 'Tanium Client CPU', Platforms: Windows, Category: Tanium
  ...
  * Sensor Name: 'Tanium Client IP Address', Platforms: Windows, Linux, Mac, Category: Tanium Diagnostics
  ...
  * Sensor Name: 'Tanium Client Neighborhood', Platforms: Windows, Category: Tanium Diagnostics
  ...
  * Sensor Name: 'Tanium Server Name', Platforms: Windows, Linux, Mac, Category: Tanium Diagnostics
  * Description: Retrieves the Tanium Server Name from the Client's Registry Example: server.domain.com

  * Sensor Name: 'Tanium Current Directory', Platforms: Windows, Category: Tanium Diagnostics
  ...
  * Sensor Name: 'Tanium Action Log', Platforms: Windows, Category: Tanium Diagnostics
  ...
  * Sensor Name: 'Logged In Users', Platforms: Windows, Linux, Mac, Category: User
  ...
  * Sensor Name: 'Last Logged In User', Platforms: Windows, Linux, Mac, Category: User
  ...
  * Sensor Name: 'User Accounts', Platforms: Linux, Category: User
  * Description: List of user accounts on a linux client machine. Example: webadmin

  * Sensor Name: 'Logged in User Details', Platforms: Windows, Category: User
  ...
  * Sensor Name: 'Last Logins', Platforms: Linux, Category: User
  ...
  * Sensor Name: 'Number of Logged In Users', Platforms: Windows, Linux, Mac, Category: User
  ...
  * Sensor Name: 'User Details', Platforms: Windows, Linux, Mac, Category: User
...
```bash
bin/print_sensors.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --platform Linux
```
...
Found items:  SensorList, len: 1696
Filtered out sourced sensors: 330
Filtered out sensors based on user filters: 94
...
```bash
bin/print_sensors.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --platform Linux --category "Operating System"
```
...
Found items:  SensorList, len: 1696
Filtered out sourced sensors: 330
Filtered out sensors based on user filters: 19
...
```bash
bin/print_sensors.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --platform Mac --platform Windows --category "User"
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Thu Sep  3 22:04:05 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**