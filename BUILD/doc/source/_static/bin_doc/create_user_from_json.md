...
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json' written with 1600 bytes
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 6050"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "user": [
    {
      ...
      "last_login": "2015-08-07T13:21:59", 
      "local_admin_flag": 1, 
      "name": "Jim Olsen CMDLINE TEST 6050", 
      "permissions": {
        "_type": "permissions", 
        "permission": [
          "admin", 
...
```
Handler for Session to 172.16.31.128:443, Authenticated: True, Version: Not yet determined!
Created item: User, name: 'Jim Olsen CMDLINE TEST 6050', id: 8, ID: 8
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Fri Aug  7 10:28:01 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**