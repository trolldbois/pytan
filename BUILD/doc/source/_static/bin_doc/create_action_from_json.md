...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 5896"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "action": [
    {
      ...
      "id": 1, 
      "name": "Distribute Tanium Standard Utilities CMDLINE TEST 5896", 
      "package_spec": {
        "_type": "package_spec", 
      ...
      "user": {
        ...
        "group_id": 0, 
        "id": 1, 
        "last_login": "2015-10-02T20:05:37", 
        "name": "Administrator"
      }
    }
  ]
...
```
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: Action, name: 'Distribute Tanium Standard Utilities CMDLINE TEST 5896', id: 140, ID: 140
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Fri Oct  2 16:06:14 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**