...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 8686"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "action": [
    {
      ...
      "id": 1, 
      "name": "Unmanaged Asset Tracking - Run Scan CMDLINE TEST 8686", 
      "package_spec": {
        "_type": "package_spec", 
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Created item: Action, name: 'Unmanaged Asset Tracking - Run Scan CMDLINE TEST 8686', ID: 1414
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Wed Feb 11 17:12:35 2015 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**