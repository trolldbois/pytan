...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 9289"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "action": [
    {
      ...
      "id": 1, 
      "name": "Distribute Tanium Standard Utilities CMDLINE TEST 9289", 
      "package_spec": {
        "_type": "package_spec", 
      ...
      "user": {
        ...
        "group_id": 0, 
        "id": 1, 
        "last_login": "2015-09-14T19:50:06", 
        "name": "Administrator"
      }
    }
  ]
...
```
PyTan v2.1.4 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: Action, name: 'Distribute Tanium Standard Utilities CMDLINE TEST 9289', id: 65, ID: 65
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Mon Sep 14 15:50:32 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**