...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 7043"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "sensor": [
    {
      ...
      "name": "Action Statuses CMDLINE TEST 7043", 
      "queries": {
        "_type": "queries", 
        "query": [
          {
...
```
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: Sensor, name: 'Action Statuses CMDLINE TEST 7043', id: 673, ID: 673
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Tue Sep 15 18:23:23 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**