...
New package '1234 CMDLINE TEST package' created with ID 135, command: 'testing.vbs $1 $2 $3 $4 $5 $6 $7 $8'
```
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Deleted item:  PackageSpec, id: 135
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Wed Feb 11 17:12:37 2015 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**