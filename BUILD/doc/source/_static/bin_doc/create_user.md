...
New user 'CMDLINE TEST user' created with ID 7, roles: 'Administrator'
```
...
```
Handler for Session to 172.16.31.128:443, Authenticated: True, Version: Not yet determined!
Deleted item:  User, name: 'CMDLINE TEST user', id: 7
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Fri Aug  7 10:27:58 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**