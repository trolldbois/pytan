...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 5430"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "sensor": [
    {
      ...
      "name": "Action Statuses CMDLINE TEST 5430", 
      "queries": {
        "_type": "queries", 
        "query": [
          {
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Created item: Sensor, name: 'Action Statuses CMDLINE TEST 5430', ID: 843
```
