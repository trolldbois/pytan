...
```bash
bin/get_user.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --id 1 --file "/tmp/out.json" --export_format json
```
  ...
  "user": [
    {
      ...
      "group_id": 0, 
      "id": 1, 
      "last_login": "2015-09-04T01:50:06", 
      "local_admin_flag": 1, 
...trimmed for brevity...
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 481"/gm' /tmp/out.json && cat /tmp/out.json
```
  ...
  "user": [
    {
      ...
      "last_login": "2015-09-04T01:50:06", 
      "local_admin_flag": 1, 
      "name": "Administrator CMDLINE TEST 481", 
      "permissions": {
        "_type": "permissions", 
        "permission": [
          "admin", 
...
```bash
bin/create_user_from_json.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 -j "/tmp/out.json"
```

```
PyTan v2.1.0 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Created item: User, name: 'Administrator CMDLINE TEST 481', id: 267, ID: 267
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Thu Sep  3 21:50:26 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**