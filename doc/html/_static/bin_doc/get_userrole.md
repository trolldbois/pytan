...
```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --file "/tmp/out.json" --export_format json
```
...
```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --file "/tmp/out.csv"
```
...
```bash
bin/get_userrole.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --all --file "/tmp/out.xml"
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Thu Sep  3 22:03:44 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**