...
New package '1234 CMDLINE TEST package' created with ID 78, command: 'testing.vbs $1 $2 $3 $4 $5 $6 $7 $8'
```
...
```
Handler for Session to 172.16.31.128:443, Authenticated: True, Version: Not yet determined!
Deleted item:  PackageSpec, id: 78
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Fri Aug  7 15:27:36 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**