...
```bash
bin/create_package.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --name "1234 CMDLINE TEST package" --display-name "1234 CMDLINE TEST package display name" --command "testing.vbs \$1 \$2 \$3 \$4 \$5 \$6 \$7 \$8" --expire-seconds 1500 --file-url "3600::testing.vbs||https://testing.com/testing.vbs" --file-url "https://testing.com/another_testing.vbs" --parameters-file "doc/example_of_all_package_parameters.json" --verify-expire-seconds 3600 --verify-filter "Custom Tags, that contains:tag" --verify-option "ignore_case" --command-timeout 600
```

```
PyTan v2.1.0 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
New package '1234 CMDLINE TEST package' created with ID 403, command: 'testing.vbs $1 $2 $3 $4 $5 $6 $7 $8'
```
...
```bash
bin/delete_package.py -u Administrator -p 'Tanium2015!' --host 10.0.1.240 --loglevel 1 --name "1234 CMDLINE TEST package"
```

```
PyTan v2.1.0 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Deleted item:  PackageSpec, id: 403
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Thu Sep  3 21:50:20 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**