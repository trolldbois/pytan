...
```
usage: get_sensor.py [-h] -u USERNAME -p PASSWORD --host HOST [--port PORT]
                     [-l LOGLEVEL] [--all] [--id ID] [--name NAME]
                     [--hash HASH] [--file REPORT_FILE] [--dir REPORT_DIR]
                     {csv,json,xml} ...
...
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json' written with 5624629 bytes
```
...
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Found items:  SensorList, len: 800
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.csv' written with 4632584 bytes
```
...
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Found items:  SensorList, len: 800
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.xml' written with 5517785 bytes
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Mon Dec  8 12:33:25 2014 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**