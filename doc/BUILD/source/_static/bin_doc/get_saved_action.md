...
Report file '/tmp/out.json' written with 6781 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SavedActionList, len: 4
Report file '/tmp/out.csv' written with 2197 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  SavedActionList, len: 4
Report file '/tmp/out.xml' written with 2197 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Fri Oct  2 16:08:28 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**