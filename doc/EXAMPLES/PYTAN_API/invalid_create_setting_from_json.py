...
create_kwargs = {}
create_kwargs['objtype'] = u'setting'
...
...CALLING: handler.get() with args: {'objtype': u'setting', 'id': 1}
...CALLING: handler.export_to_report_file() with args: {'report_dir': '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T', 'export_format': 'json', 'obj': <taniumpy.object_types.system_setting_list.SystemSettingList object at 0x11b4a4fd0>}
...CALLING: handler.create_from_json() with args {'objtype': u'setting', 'json_file': '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/SystemSettingList_2015_09_14-16_15_20-EDT.json'}
...EXCEPTION: setting is not a json createable object! Supported objects: user, whitelisted_url, saved_question, group, package, question, action, sensor
