...
...CALLING: handler.export_obj() with args {'export_format': u'json', 'obj': <taniumpy.object_types.sensor_list.SensorList object at 0x10c69ad50>, 'include_type': u'bad'}
...EXCEPTION: 'include_type' must be one of [<type 'bool'>], you supplied <type 'unicode'>!
