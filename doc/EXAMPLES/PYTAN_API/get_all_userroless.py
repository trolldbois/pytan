...
...CALLING: handler.get_all with args: {'objtype': u'userrole'}
...OUTPUT: Type of response:  <class 'taniumpy.object_types.user_role_list.UserRoleList'>
...OUTPUT: print of response:
UserRoleList, len: 9
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.user_role_list.UserRoleList object at 0x109cb9590>}
