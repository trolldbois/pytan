...
...CALLING: handler.get with args: {'objtype': u'saved_question', 'name': [u'Installed Applications', u'Computer Name']}
...OUTPUT: Type of response:  <class 'taniumpy.object_types.saved_question_list.SavedQuestionList'>
...OUTPUT: print of response:
SavedQuestionList, len: 2
...CALLING: handler.export_obj() with args {'export_format': 'json', 'obj': <taniumpy.object_types.saved_question_list.SavedQuestionList object at 0x108c4a350>}
