...
New package '1234 CMDLINE TEST package' created with ID 96, command: 'testing.vbs $1 $2 $3 $4 $5 $6 $7 $8'
```
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Deleted item:  PackageSpec, id: 96
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Mon Dec  8 14:59:46 2014 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**