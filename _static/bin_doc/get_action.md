...
Found items:  ActionList, len: 138
Report file '/tmp/out.json' written with 201282 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  ActionList, len: 138
Report file '/tmp/out.csv' written with 51008 bytes
```
...
PyTan v2.1.6 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  ActionList, len: 138
Report file '/tmp/out.xml' written with 51008 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Fri Oct  2 16:07:56 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**