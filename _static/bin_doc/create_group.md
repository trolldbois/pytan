...
New group 'All Windows Computers CMDLINE TEST GROUP' created with ID 795, filter text: ' Operating System contains "Windows" and IP Address = "10.10.10.10"'
```
...
###### generated by: `build_bin_doc v1.4.5`, date: Mon Dec  8 12:32:39 2014 EST, Contact info: **Jim Olsen <jim.olsen@tanium.com>**