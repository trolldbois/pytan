...
Found items:  QuestionList, len: 2117
Report file '/tmp/out.json' written with 1639034 bytes
```
...
```
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  QuestionList, len: 2118
Report file '/tmp/out.csv' written with 326158 bytes
```
...
PyTan v2.1.5 Handler for Session to 10.0.1.240:443, Authenticated: True, Platform Version: 6.5.314.4301
Found items:  QuestionList, len: 2118
Report file '/tmp/out.xml' written with 326158 bytes
```
...
###### generated by: `build_bin_doc v2.1.0`, date: Tue Sep 15 18:24:44 2015 EDT, Contact info: **Jim Olsen <jim.olsen@tanium.com>**