...
Report file '/var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json' written with 4588 bytes
```
...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 4276"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "saved_question": [
    {
      ...
      "name": "Run Unmanaged Asset Scan on All Machines CMDLINE TEST 4276", 
      "packages": {
        "_type": "package_specs", 
        "package_spec": []
      }, 
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Created item: SavedQuestion, name: 'Run Unmanaged Asset Scan on All Machines CMDLINE TEST 4276', ID: 177
```
