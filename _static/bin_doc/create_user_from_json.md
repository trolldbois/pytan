...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 4418"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "user": [
    {
      ...
      "id": 1, 
      "last_login": "2014-12-08T19:28:09", 
      "name": "Jim Olsen CMDLINE TEST 4418", 
      "permissions": {
        "_type": "permissions", 
        "permission": "admin"
      }, 
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Created item: User, name: 'Jim Olsen CMDLINE TEST 4418', ID: 14
```
