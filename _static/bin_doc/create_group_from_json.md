...
```bash
perl -p -i -e 's/^(      "(name|url_regex)": ".*)"/$1 CMDLINE TEST 9619"/gm' /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json && cat /var/folders/dk/vjr1r_c53yx6k6gzp2bbt_c40000gn/T/out.json
```
  ...
  "group": [
    {
      ...
      "id": 1, 
      "name": "All Computers CMDLINE TEST 9619", 
      "not_flag": 0, 
      "sub_groups": {
        "_type": "groups", 
        "group": []
...
```
Handler for Session to 172.16.31.128:444, Authenticated: True, Version: 6.2.314.3258
Created item: Group, name: 'All Computers CMDLINE TEST 9619', ID: 796
```
