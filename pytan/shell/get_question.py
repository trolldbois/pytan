...
class Worker(base.Base):
    DESCRIPTION = 'Get question information and export to a report file'
    GROUP_NAME = 'Question Search Options'
    ACTION = 'question'
    PREFIX = 'get_question'
    ...
    def setup(self):
        ...
        self.grp.add_argument(
            ...
            help='Searchable text string for finding questions'
        )
        self.add_help_opts()
    ...
    def get_response(self, kwargs):
        ...
        response = self.handler.get_questions(**kwargs)
