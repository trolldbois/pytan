...
class Worker(base.Base):
    DESCRIPTION = 'Searches for and deletes sensors.'
    GROUP_NAME = 'Delete Sensor Options'
    ACTION = 'delete'
    PREFIX = 'delete_sensor'
    NAME = 'sensor'
    ...
    def get_response(self, kwargs):
        ...
        response = self.handler.delete_sensors(really_delete=True, **kwargs)
