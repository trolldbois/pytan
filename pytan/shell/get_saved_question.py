...
class Worker(base.Base):
    DESCRIPTION = 'Get saved questions information and export to a report file'
    GROUP_NAME = 'Saved Questions Search Options'
    ACTION = 'question'
    PREFIX = 'get_saved_question'
    ...
    def get_response(self, kwargs):
        ...
        response = self.handler.get_saved_questions(**kwargs)
