...
class Worker(base.Base):
    DESCRIPTION = 'Searches for and deletes packages.'
    GROUP_NAME = 'Delete Package Options'
    ACTION = 'delete'
    PREFIX = 'delete_package'
    NAME = 'packages'
    ...
    def get_response(self, kwargs):
        ...
        response = self.handler.delete_packages(really_delete=True, **kwargs)
