...
class Worker(base.Base):
    DESCRIPTION = 'Get Saved Actions information and export to a report file'
    GROUP_NAME = 'Saved Actions Search Options'
    ACTION = 'action'
    PREFIX = 'get_saved_action'
    NAME = 'saved actions'
    ...
    def get_response(self, kwargs):
        ...
        response = self.handler.get_saved_actions(**kwargs)
