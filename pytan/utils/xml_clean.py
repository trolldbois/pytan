...
def xml_cleaner(text, **kwargs):
    ...
    replacement = kwargs.get('replacement', DEFAULT_REPLACEMENT)
    ...
    if perform_xml_clean:
        ...
        result, cnt = INVALID_UNICODE_RE.subn(replacement, result)
        ...
        if clean_restricted:
            ...
            result, cnt = RESTRICT_UNICODE_RE.subn(replacement, text)
