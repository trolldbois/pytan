...
LOG_LEVEL_MAPS = {
    ...
    'pytan.utils.tools': 1,
    'pytan.tickle': 1,
    'pytan.tickle.serialize': 1,
    'pytan.tickle.deserialize': 1,
    ...
    'pytan.utils.log': 10,
    'pytan.requests': 11,
    'pytan.requests.packages.urllib3': 11,
    'pytan.requests.packages.urllib3.connectionpool': 11,
    'pytan.requests.packages.urllib3.poolmanager': 11,
    'pytan.requests.packages.urllib3.util.retry': 11,
}
"""
