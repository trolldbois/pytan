...
examples = [
    {
        'name': 'Export package id 1 as JSON',
        'cmd': 'get_package.py $API_INFO --id 1 --file "$TMP/out.json" json',
        'notes': ['Get the first package object', 'Save the results to a JSON file'],
    ...
    {
        'name': 'Create a new package from the modified JSON file',
        'cmd': 'create_package_from_json.py $API_INFO -j "$TMP/out.json"',
