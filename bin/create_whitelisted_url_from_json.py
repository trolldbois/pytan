...
examples = [
    {
        'name': 'Export whitelisted_url id 1 as JSON',
        'cmd': 'get_whitelisted_url.py $API_INFO --id 1 --file "$TMP/out.json" json',
        'notes': ['Get the first whitelisted_url object', 'Save the results to a JSON file'],
    ...
    {
        'name': 'Create a new whitelisted_url from the modified JSON file',
        'cmd': 'create_whitelisted_url_from_json.py $API_INFO -j "$TMP/out.json"',
