...
examples = [
    {
        'name': 'Export question id 1 as JSON',
        'cmd': 'get_question.py $API_INFO --id 1 --file "$TMP/out.json" json',
        'notes': ['Get the first question object', 'Save the results to a JSON file'],
    ...
    {
        'name': 'Create a new question from the modified JSON file',
        'cmd': 'create_question_from_json.py $API_INFO -j "$TMP/out.json"',
