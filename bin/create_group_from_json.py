...
examples = [
    {
        'name': 'Export group id 1 as JSON',
        'cmd': 'get_group.py $API_INFO --id 1 --file "$TMP/out.json" json',
        'notes': ['Get the first group object', 'Save the results to a JSON file'],
    ...
    {
        'name': 'Create a new group from the modified JSON file',
        'cmd': 'create_group_from_json.py $API_INFO -j "$TMP/out.json"',
