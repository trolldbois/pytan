...
raw_resultset_xmls = [
    {
        'xml_file': 'resultdata_Computer Name and IP Route Details_raw.xml',
    ...
    {
        'xml_file': 'resultdata_sse_Computer Name and IP Route Details_raw.xml',
        'obj_type': tanium_ng.ResultSetList,
        'obj_tag': 'result_sets',
        'complex_type': tanium_ng.ResultSet,
        'complex_tag': 'result_set',
...
raw_tanium_xmls = [
    ...
    {
        'xml_file': 'questions_Last 5 minutes of questions_raw.xml',
    ...
    {
        'xml_file': 'actions_Last 5 minutes of actions_raw.xml',
    ...
    {
        'xml_file': 'resultinfo_Computer Name and IP Route Details_raw.xml',
...
def test_to_csv_resultset(resultxml_info, report_tmpdir):
    obj1 = test_from_xml(resultxml_info)
    obj1_csv = tickle.to_csv_resultset(obj1)
    assert obj1_csv
    assert isinstance(obj1_csv, string_types)
    fn = 'RESULTSET_test_to_csv_{}.csv'.format(resultxml_info['xml_file'])
    p = report_tmpdir.join(fn)
    p.write(obj1_csv)
